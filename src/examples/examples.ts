import { BLOCK, COL, imAlign, imFixed, imJustify, imLayout, imLayoutBegin, imLayoutBeginInternal, imLayoutEnd, imPadding, imSize, NA, newColor, newColorFromHsv, newCssBuilder, PX, ROW } from "src/utils/im-ui";
...
const tests: VisualTest[] = [
    newVisualTest("imJS - A complete overview", (c, harness) => {
        imBaseContainerBegin(c); {
            ...
            imParaBegin(c); {
                imStr(c, `imJS is actually written entirely in TypeScript. I just didn't like the name imTS very much. In order to use it, you'll need to copy the im-core.ts, im-dom.ts and assert.ts files to some vendor or util directory in your project, where you can import the functions and types that they export. `);
            ...
            imParaBegin(c); {
                imStr(c, `Components are just functions. Control-flow is not so straightforward though, and I'll discuss this later. Here's a simple date-time component to demonstrate:`);
            } imParaEnd(c);

            imVisualTestInstallation(c, "Simple component", harness, imSimpleComponent, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "Counter", harness, imSimpleComponentCounter, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "Counter - refactored", harness, imSimpleComponentCounterRefactored, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "Conditional rendering - broken", harness, imConditionalRenderingExampleIfStatementBad, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "Conditional rendering", harness, imConditionalRenderingExampleIfStatementNotBad, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "List rendering - broken", harness, imListRenderingExampleBad, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "List rendering", harness, imListRenderingExampleFixed, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "List rendering - keyed", harness, imListRenderingExampleKeyed, undefined, TEST_CENTERED);

            imParaBegin(c); {
                imStr(c, `It's a bit of a contrived example, since I could have just as easily wrote it without keying:`);
            } imParaEnd(c);

            imVisualTestInstallation(c, "List rendering - keyed example but not keyed", harness, imListRenderingExampleNotKeyed, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "imKeyed wrong tool for the job", harness, imSwitchExampleWithKeyedDontDoItLikeThis, undefined, TEST_CENTERED);

            imParaBegin(c); {
                imStr(c, `However, there is a problem. Usage code that might reuse your component in the same scope will no longer work: `);
            } imParaEnd(c);

            imVisualTestInstallation(c, "imKeyed wrong tool for the job - usage code", harness, imSwitchExampleWithKeyedUsageCode, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "use imSwitch instead", harness, imSwitchExample, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "imSwitch usage code", harness, imSwitchExampleWithUsageCode, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "Error boundary", harness, imErrorBoundaryExampleView, undefined, TEST_CENTERED);
            ...
            imVisualTestInstallation(c, "imMemo 90% of usecases", harness, imMemoExamples, undefined, TEST_CENTERED);
